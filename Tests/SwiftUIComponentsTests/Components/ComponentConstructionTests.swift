...
func themedComponentsAreConstructible() {
    ...
    _ = Text("Error")
        ...
        .designCardSurface()
    _ = DesignText("Localized label", slot: .headlineSemibold)
    _ = DesignText(verbatim: "Verbatim label", slot: .captionSemibold)
    ...
    _ = SectionHeader(title: "Recent Items", actionLabel: "See All") {}
    ...
    _ = CompactActionButton(title: "Details", icon: "book") {}
    _ = CompactActionButton(title: "Share", icon: "globe", isDisabled: true) {}
