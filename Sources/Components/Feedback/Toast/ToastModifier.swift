        ...
        DragGesture()
            ...
            .onEnded { value in
                ...
                if shouldDismiss {
                    ...
                    withAnimation(theme.motion.animation(reducingMotion: reduceMotion)) { dragOffset = 0 }
                }
            }
    }

    private func dismiss() {
        withAnimation(theme.motion.animation(reducingMotion: reduceMotion)) { isPresented = false }
        dragOffset = 0
    }
}
